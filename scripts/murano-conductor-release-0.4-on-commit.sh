...
expect murano-tests/infra/deploy_component.sh ubuntu 10.100.0.23 $GERRIT_REFSPEC murano-conductor
...
sed -i "s/murano_url = http:\/\/127.0.0.1:8082/murano_url = http:\/\/10.100.0.23:8082/" etc/tempest.conf
sed -i "s/murano_metadata = http:\/\/127.0.0.1:8084/murano_metadata = http:\/\/10.100.0.23:8084/" etc/tempest.conf
